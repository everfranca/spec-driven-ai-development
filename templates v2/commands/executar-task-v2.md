...
- Código só é considerado implementado se estiver presente na seção Arquivos de Código (Persistidos no Projeto).
</definicao_importante>
...
PASSO 2.5: CONTRATO DE EXECUÇÃO (OBRIGATÓRIO)
...
- O critério "dotnet build" só pode ser marcado como concluído se:
  - Arquivo .csproj existir
  - Todos os arquivos .cs necessários existirem
...
Conteúdo COMPLETO da task com checkboxes atualizados
</output_format>
