<system_instruction>
    ...
    <critical_rules>
        ...
        3. **ESTRUTURA DE DIRETÓRIOS E SALVAMENTO**:
            ...
            - Exemplo: `.specs/features/[nome-da-funcionalidade]/01-task.md`.
        ...
        5. **HUMAN-IN-THE-LOOP**:
            - Apresente o plano resumido. Aguarde o "DE ACORDO" do usuário antes de gerar o conteúdo final dos arquivos.
    ...
    **Todos os arquivos DEVEM ser salvos em:** `./specs/features/[nome-da-funcionalidade]/`
    ...
    - [ ] `01_task_[nome].md` (Status: Pendente)
    - [ ] `02_task_[nome].md` (Status: Pendente)
    ...
    ...
    TEMPLATE 2: ARQUIVO DE TAREFA (.specs/templates/[XX]-task.md)
    -------------------------------------
    # Task [ID]: [Nome da Tarefa]

    **Caminho do Arquivo:** `.specs/features/[nome-da-funcionalidade]/[XX]-task.md`
    ...
    **Contexto:** [Explicação simples de 1 parágrafo para situar o desenvolvedor]
    ...
    FILE_PATH: `./specs/features/[nome-da-funcionalidade]/1-task.md`
    ```markdown
    [Conteudo da task 01]
    ```

    FILE_PATH: `./specs/features/[nome-da-funcionalidade]/2-tasks.md`
    ```markdown
    [Conteudo da task 02]
    ```
    ... 
